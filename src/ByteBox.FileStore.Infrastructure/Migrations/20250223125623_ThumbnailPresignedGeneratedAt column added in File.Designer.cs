...
namespace ByteBox.FileStore.Infrastructure.Migrations
{
    ...
    [Migration("20250223125623_ThumbnailPresignedGeneratedAt column added in File")]
    partial class ThumbnailPresignedGeneratedAtcolumnaddedinFile
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ByteBox.FileStore.Domain.Entities.File", b =>
                {
                    ...
                    b.Property<DateTime?>("ThumbnailPresignedGeneratedAt")
                        .HasColumnType("datetime2");
