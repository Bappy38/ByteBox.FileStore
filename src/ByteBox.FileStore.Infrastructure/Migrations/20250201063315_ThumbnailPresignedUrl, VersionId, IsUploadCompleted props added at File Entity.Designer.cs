...
namespace ByteBox.FileStore.Infrastructure.Migrations
{
    ...
    [Migration("20250201063315_ThumbnailPresignedUrl, VersionId, IsUploadCompleted props added at File Entity")]
    partial class ThumbnailPresignedUrlVersionIdIsUploadCompletedpropsaddedatFileEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ByteBox.FileStore.Domain.Entities.File", b =>
                {
                    ...
                    b.Property<string>("ThumbnailPresignedUrl")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
